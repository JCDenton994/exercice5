...
NoSuchMethodError: {"": "Error_StackTraceOnThrow1;_liblib1$_receiver,_memberName,_arguments,_namedArguments,_existingArgumentNames",
  toString$0: function(_) {
    var t1, t2, t3, t4;
    t1 = {};
...
["sierpinski_triangle", "sierpinski_triangle.dart", , {
Board: {"": "Object;context",
  triangle$4: function(x, y, dx, dy) {
    $.beginPath$0$x(this.context);
    $.set$fillStyle$x(this.context, "#000000");
    $.moveTo$2$x(this.context, x, y);
    $.lineTo$2$x(this.context, x + dx, y - dy);
    $.lineTo$2$x(this.context, x + 2 * dx, y);
    $.closePath$0$x(this.context);
    $.fill$0$x(this.context);
    $.stroke$0$x(this.context);
  },
  triangleblanc$4: function(x, y, dx, dy) {
    var t1;
    $.beginPath$0$x(this.context);
    $.set$fillStyle$x(this.context, "#FFFFFF");
    t1 = y - dy / 2;
    $.moveTo$2$x(this.context, x + dx / 2, t1);
    $.lineTo$2$x(this.context, x + 1.5 * dx, t1);
    $.lineTo$2$x(this.context, x + dx, y);
    $.closePath$0$x(this.context);
    $.fill$0$x(this.context);
    $.stroke$0$x(this.context);
  },
  Board$1: function(canvas) {
    this.context = $.getContext$1$x(canvas, "2d");
  }
},

main_closure: {"": "Closure;x_0,y_1,dx_2,dy_3,board_4",
  call$1: function(e) {
    ...
    while (true) {
      ...
      if (typeof t7 !== "number")
        throw $.iae(t7);
      t1.triangleblanc$4(t2 + t3 * t7, t4, t3 / t6, t5 / t6);
      ++i;
    }
    $.document().querySelector("#iterations").textContent = $.toString$0($.t);
    $.t = $.$add$ns($.t, 1);
  }
},
...
main: function() {
  var board = $.Board$($.document().querySelector("#canvas"));
  board.triangle$4(10, 300, 300, 300);
  $.get$onClick$x($.document().querySelector("#play")).listen$1(new $.main_closure(10, 300, 300, 300, board));
}}],
]);
...
//@ sourceMappingURL=sierpinski_triangle.dart.js.map
